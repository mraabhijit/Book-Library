...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
                ...
                response_deserializer=protos_dot_auth__pb2.Staff.FromString,
        ...
        self.GetCurrentUser = channel.unary_unary(
                '/library.AuthService/GetCurrentUser',
                request_serializer=protos_dot_auth__pb2.GetCurrentUserRequest.SerializeToString,
                response_deserializer=protos_dot_auth__pb2.Staff.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Register': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=protos_dot_auth__pb2.Staff.SerializeToString,
            ),
            ...
            'GetCurrentUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_auth__pb2.GetCurrentUserRequest.FromString,
                    response_serializer=protos_dot_auth__pb2.Staff.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def Register(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            protos_dot_auth__pb2.Staff.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetCurrentUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/library.AuthService/GetCurrentUser',
            protos_dot_auth__pb2.GetCurrentUserRequest.SerializeToString,
            protos_dot_auth__pb2.Staff.FromString,
            options,
            channel_credentials,
            insecure,
